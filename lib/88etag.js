(function() {
  var AiPlayer, Bullet, BulletsStorage, Client, CommandCentre, CommandCentreInner, Controller, HealthBall, Indicator, LocalPlayer, MassDriver, MassDriverFire, Movable, Player, PlayerShip, Server, ShipBullet, ShipTrail, Starfield, Trail, TrailsStorage, Turret, TurretBase, TurretBullet, TurretBulletTrail, Universe,
  ...
  Movable = (function() {
    ...
    Movable.prototype.step = function() {
      ...
      if (!this.velocity.isZero()) {
        ...
        this.controller.client.objectMoved(this);
      }
  ...
  Client = (function() {
    ...
    Client.prototype.connect = function(host, callback) {
      ...
      this.socket.on('objectCreated', function(data) {
        if (data.clientId !== this.id) return console.log('Object created', data);
      });
      this.socket.on('objectMoved', function(data) {
        if (data.clientId !== this.id) return console.log('Object moved', data);
      });
      return this.socket.on('objectDestroyed', function(data) {
        if (data.clientId !== this.id) {
          return console.log('Object destroyed', data);
        }
      });
    };
  ...
  Server = (function() {
    ...
    Server.prototype.start = function(io) {
      ...
      return this.io.sockets.on('connection', function(socket) {
        ...
        return socket.on('objectDestroyed', function(data) {
