(function() {
  ...
  Starfield = (function() {
    ...
    function Starfield(controller) {
      ...
      this.controller = controller;
      this.screen_range_x = Math.tan(this.controller.camera.fov * Math.PI / 180) * this.controller.camera.position.z * 2;
    ...
    Starfield.prototype.step = function() {
      ...
      this.camera_x_min = this.controller.camera.position.x - (this.screen_range_x / 2);
      this.camera_x_max = this.controller.camera.position.x + (this.screen_range_x / 2);
      this.camera_y_min = this.controller.camera.position.y - (this.screen_range_y / 2);
      this.camera_y_max = this.controller.camera.position.y + (this.screen_range_y / 2);
