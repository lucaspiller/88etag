(function() {
  var BulletsStorage, CommandCentre, CommandCentreInner, Controller, HealthBall, LocalPlayer, Movable, Player, PlayerShip, ShipBullet, ShipTrail, Starfield, TrailsStorage, Universe,
  ...
  Controller = (function() {
    ...
    Controller.prototype.models = ['models/ship_basic.js', 'models/command_centre.js', 'models/command_centre_inner.js'];
  ...
  PlayerShip = (function(_super) {
    ...
    PlayerShip.prototype.maxHealth = 100;

    PlayerShip.prototype.radius = 10;

    PlayerShip.prototype.mass = 1;
    ...
    function PlayerShip(options) {
      ...
      this.position.y = this.commandCentre.position.y - this.commandCentre.radius - 10;
  ...
  Player = (function() {
    ...
    function Player(options) {
      this.universe = options.universe;
      this.controller = options.controller;
      this.ship = new PlayerShip(options);
    }
