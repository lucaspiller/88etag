(function() {
  ...
  Controller = (function() {
    ...
    Controller.prototype.render = function() {
      ...
      this.universe.step();
      this.light1.position.set(this.camera.position.x + 100, this.camera.position.y + 100, 500);
      this.light2.position.set(this.camera.position.x - 100, this.camera.position.y - 100, 500);
      this.light3.position.set(this.camera.position.x, this.camera.position.y, CAMERA_Z);
  ...
  Player = (function(_super) {
    ...
    Player.prototype.forward = function() {
      ...
      if (accel > this.max_accel) {
        return this.acceleration.multiplyScalar(this.max_accel / accel);
      }
    };
