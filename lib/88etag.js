(function() {
  var AiPlayer, Bullet, BulletsStorage, CommandCentre, CommandCentreInner, Controller, HealthBall, LocalPlayer, MassDriver, Movable, Player, PlayerShip, ShipBullet, ShipTrail, Starfield, Trail, TrailsStorage, Turret, TurretBase, TurretBullet, TurretBulletTrail, Universe,
  ...
  Trail = (function(_super) {
    ...
    Trail.prototype.step = function() {
      if (this.alive) {
        if (this.lifetime > 0) {
          this.position.addSelf(this.velocity);
          this.mesh.material.opacity = this.lifetime / this.max_lifetime;
          return this.lifetime--;
        } else {
          return this.remove();
        }
