(function() {
  var AiPlayer, Bullet, BulletsStorage, CommandCentre, CommandCentreInner, Controller, HealthBall, Indicator, LocalPlayer, MassDriver, MassDriverFire, Movable, Player, PlayerShip, Server, ShipBullet, ShipTrail, Starfield, Trail, TrailsStorage, Turret, TurretBase, TurretBullet, TurretBulletTrail, Universe,
  ...
  Server = (function() {
    ...
    Server.prototype.start = function(io) {
      this.io = io;
      return console.log('Server started, yay!');
    };
