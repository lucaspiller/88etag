(function() {
  var AiPlayer, Bullet, BulletsStorage, CommandCentre, CommandCentreInner, Controller, HealthBall, LocalPlayer, MassDriver, Movable, Player, PlayerShip, ShipBullet, ShipTrail, Starfield, TrailsStorage, Turret, TurretBase, TurretBullet, Universe,
  ...
  Bullet = (function(_super) {
    ...
    Bullet.prototype.remove = function() {
      this.alive = false;
      return this.position.z = this.controller.NEAR;
    };
  ...
  TurretBullet = (function(_super) {
    ...
    TurretBullet.prototype.step = function() {
      ...
      if (this.alive) return this.universe.trails.newShipTrail(this);
    };
  ...
  MassDriver = (function(_super) {
    ...
    MassDriver.prototype.mass = 10000;
    ...
    MassDriver.prototype.rotateLeft = function() {
      return this.rotationalVelocity = Math.PI / 64;
    };

    MassDriver.prototype.rotateRight = function() {
      return this.rotationalVelocity = -Math.PI / 64;
    };

    MassDriver.prototype.rotateStop = function() {
