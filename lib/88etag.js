...
(function() {
  ...
  LocalPlayer = (function(_super) {
    ...
    LocalPlayer.prototype.positionFor = function(type) {
      ...
      position.x += Math.sin((Math.PI / 2) - this.ship.rotation) * (type.prototype.radius + this.ship.radius);
      position.y += Math.cos((Math.PI / 2) - this.ship.rotation) * (type.prototype.radius + this.ship.radius);
      return position;
    };
