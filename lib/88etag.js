(function() {
  var CommandCentre, Controller, HealthBall, LocalPlayer, Movable, Player, ShipTrail, Starfield, TrailsContainer, Universe,
  ...
  HealthBall = (function() {
    ...
    HealthBall.prototype.update = function(position, health) {
      ...
      return this.innerMesh.scale.set(health / this.healthMax, health / this.healthMax, 1);
    };
  ...
  Movable = (function() {
    ...
    Movable.prototype.healthMax = 100;
