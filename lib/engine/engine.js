...
Universe = (function() {
  ...
  Universe.prototype.removePlayer = function(player) {
  ...
  Universe.prototype.gameOver = function() {
    if (this.controller.config.onGameOver) {
      return this.controller.config.onGameOver();
    }
  };
